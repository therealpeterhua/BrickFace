(function() {
  ...
  FaceDetect.prototype.handleDetectedFaces = function(faces) {
    ...
    var smoothedFace = this.preprocessDetection(largestFace);
    if (!smoothedFace) { return; }

    this.drawFaceBox(smoothedFace, true);
    var coord = smoothedFace[0] + (smoothedFace[2] / 2);
  ...
  FaceDetect.prototype.preprocessDetection = function(face) {
    return face;
    //PH**** - pass this to the smoother and have it return!
  };
